<template>
  <div class="d-flex align-items-center justify-content-center">
    <img src="../assets/Component4.png" class="w-full p-5" />
  </div>
  <div class="container justify-center-center mt-5 align-items-center">
    <!-- Botões superiores -->
    <div class="row mb-3">
      ...
      <div class="col-4 mb-4 ">
        <button
          type="button"
          class="btn btn-custom"
          @click="redirectToPage('FolhaPagamento')"
        >
          <div class="custom mb-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="col-4 mb-3">
        <button
          type="button"
          class="btn btn-custom"
          @click="redirectToPage('FolhaPonto')"
        >
          <div class="custom mb-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row mt-4 mb-4">
      ...
      <div class="col-4 mb-4">
        <button
          type="button"
          class="btn btn-custom"
          @click="redirectToPage('Relatorios')"
        >
          <div class="custom mb-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
